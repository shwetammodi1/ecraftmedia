...
const onPageFactors = [
  ...
  },
  {
    ...
    desc: 'User experience is crucial in 2017 so resolve all the 404, 500 errors. You can also use the 301 redirection for the broken links to pass the link juice or delete if it is not anywhere linked to the sites.',
  },
  {
    n: 10,
    title: 'Sitemaps',
