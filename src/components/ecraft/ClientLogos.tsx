...
export default function ClientLogos() {
  ...
  return (
    ...
    >
      {/* Label */}
      <p className="text-center text-[10.5px] font-bold tracking-[0.22em] uppercase text-slate-600 mb-8">
      ...
      <div className="flex animate-marquee whitespace-nowrap" style={{ width: 'max-content' }}>
        {doubled.map((logo, i) => (
          <div
            key={i}
            className="inline-flex items-center justify-center mx-10 h-10 w-28 flex-shrink-0 opacity-35 hover:opacity-70 transition-opacity duration-300"
          >
            <img
              src={logo.src}
              alt={logo.alt}
