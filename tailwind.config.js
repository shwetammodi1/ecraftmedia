...
export default {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        soft: '0 1px 2px rgba(0,0,0,0.4), 0 16px 40px -16px rgba(0,0,0,0.55)',
        'soft-light': '0 1px 2px rgba(15,23,42,0.04), 0 16px 40px -16px rgba(15,23,42,0.14)',
        glow: '0 12px 36px -8px rgba(245,158,11,0.35)',
      },
      animation: {
